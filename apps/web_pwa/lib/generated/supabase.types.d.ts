...
export type Database = {
    public: {
        ...
        Enums: {
            ...
            order_status: "draft" | "placed" | "confirmed" | "picking" | "shipped" | "delivered" | "cancelled";
            price_list_scope: "global" | "customer";
            shipment_status: "pending" | "ready" | "in_transit" | "delivered" | "cancelled";
            user_role: "admin" | "vendor_admin" | "vendor_user" | "customer_admin" | "buyer";
        };
        CompositeTypes: {
            [_ in never]: never;
        };
...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly company_status: readonly ["pending", "active", "suspended", "rejected"];
            readonly company_type: readonly ["admin", "vendor", "customer"];
            readonly order_status: readonly ["draft", "placed", "confirmed", "picking", "shipped", "delivered", "cancelled"];
            readonly price_list_scope: readonly ["global", "customer"];
            readonly shipment_status: readonly ["pending", "ready", "in_transit", "delivered", "cancelled"];
            readonly user_role: readonly ["admin", "vendor_admin", "vendor_user", "customer_admin", "buyer"];
        };
    };
};
export {};
