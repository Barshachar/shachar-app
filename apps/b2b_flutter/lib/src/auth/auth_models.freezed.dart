...
mixin _$UserProfile {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, email, role, companyType,
      companyId, displayName, locale);

  @override
  String toString() {
    return 'UserProfile(id: $id, email: $email, role: $role, companyType: $companyType, companyId: $companyId, displayName: $displayName, locale: $locale)';
  }
}
...
extension UserProfilePatterns on UserProfile {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _UserProfile() when $default != null:
        return $default(_that.id, _that.email, _that.role, _that.companyType,
            _that.companyId, _that.displayName, _that.locale);
      case _:
        return orElse();
    }
  }
