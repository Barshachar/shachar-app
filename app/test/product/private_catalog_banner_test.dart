...
void main() {
  ...
  testWidgets('Product page shows not-in-catalog banner when gated',
      (tester) async {
    ...
    final bannerFinder = find.byKey(const ValueKey('not_in_catalog_banner'),
        skipOffstage: false);
    expect(bannerFinder, findsOneWidget);

    final AButton addButton = tester.widget<AButton>(
      find.byKey(const ValueKey('product_add_to_cart_btn')),
    );
