...
values
  ...
  ('44444444-4444-4444-4444-444444444444', 'barshahar2@gmail.com', crypt('Bar123456', gen_salt('bf')), now(), '{"full_name":"Bar Shahar","locale":"en"}', '{"role":"buyer","company_id":"30000000-0000-0000-0000-000000000000","company_type":"customer"}', now());
